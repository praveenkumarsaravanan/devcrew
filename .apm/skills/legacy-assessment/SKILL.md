...
Scan the codebase across six dimensions. For each, assign a maturity level (None / Basic / Moderate / Strong):
...
- **M1 — Safety Net (Week 1-2):** Add linting, secret scanning, basic CI pipeline, initial test coverage for critical paths
