...
<!-- Required for medium/high-risk work. Summarize or link the release evidence bundle. -->
...
- [ ] Release evidence included for medium/high-risk work (if applicable)
```
...
- **`/release-evidence`** — For medium/high-risk work, build or review the evidence bundle before PR/release approval.
