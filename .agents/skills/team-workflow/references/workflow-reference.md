# DevCrew Engineering Flow Reference
...
```
## DevCrew Engineering Flow Summary

| Phase | Status | Execution | Key Decision / Output |
|---|---|---|---|
| 0. Detection + Sizing | Completed | Inline | Discipline: [backend/frontend/fullstack], size: [size], risk: [risk], council depth: [depth] |
